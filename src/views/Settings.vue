  ...
  <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
    ...
    <form @submit.prevent="updateUserDetails">
        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            ...
            <div>
            <p class="py-2 mt-0 md:mt-8 text-sm text-center text-gray-400">Changed password? <a href="#" class="text-blue-500 focus:outline-none focus:underline hover:underline">Click here</a>.</p>
            </div>
        </div>
